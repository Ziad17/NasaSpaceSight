...
public class HorizontalDotted extends View {
    ...
    public HorizontalDotted(Context context) {
        super(context);
    }

    public HorizontalDotted(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HorizontalDotted(Context context, AttributeSet attrs, int defStyleAttr) {
