...
public class NormalImageRecycleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public NormalImageRecycleAdapter(Context context,  OnImageClickLisetenr _onImageClickLisetenr) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycle_item_normal_image, parent, false);
